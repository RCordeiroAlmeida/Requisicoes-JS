...
async function listaVideos(){
    try{
        ...
        //pra cada item da lista contida em db.json foi adicionado um card, sendo filho do elemento <ul class="videos__container" alt="videos alura" data-lista>
...
listaVideos(); //renderiza a função